...
public class FrmQLKhuyenMai extends JPanel {
	...
	private JPanel createCenter() {
		...
		// Columns: Tên KM | Mô tả | Giá trị | Thời gian | Trạng thái | Đã sử dụng |
		// Thao tác
		...
		// Renderer cột Tên KM (2 dòng: tên + mô tả điều kiện)
		...
		// Renderer cột Giá trị (màu đỏ bold)
		...
		// Renderer cột Thao tác (icon sửa + xóa)
