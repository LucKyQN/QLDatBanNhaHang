...
public class FrmQLNhanVien extends JPanel {
    ...
    private JPanel createTopBar() {
        ...
        btnXoa.addActionListener(e -> xoaMemNhanVien());
    ...
    private NhanVien getNhanVienDangChon() {
        ...
        if (row < 0 || row >= dsNhanVien.size()) return null;
    ...
    private void xoaMemNhanVien() {
        ...
        int confirm = JOptionPane.showConfirmDialog(
                this,
                "Xác nhận xóa mềm nhân viên " + nv.getMaNV() + " - " + nv.getHoTenNV() + "?",
                "Xóa mềm nhân viên",
