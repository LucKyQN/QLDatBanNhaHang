...
//            JPanel btn = createMenuButton(item[0], item[1], "Dashboard".equals(item[1]));
//            menuPanel.add(btn);
...
//    }
//
//    private JPanel createMenuButton(String icon, String label, boolean isActive) {
...
//        lbLabel.setFont(new Font("Segoe UI", isActive ? Font.BOLD : Font.PLAIN, 13));
//        lbLabel.setForeground(isActive ? RED_MAIN : TEXT_DARK);
//
//        btn.add(lbIcon);
//        btn.add(lbLabel);
//
...
//
//        JLabel lbSub = new JLabel("Tổng quan hoạt động nhà hàng - Xin chào " + tenNhanVien);
...
//    }
//
//    private JPanel createStatCard(String icon, String label, String value, String badge, boolean badgePositive, Color iconColor) {
...
//        Object[][] data = {
//                {"Nguyễn Văn A", "Ca sáng", "Đang mở", "07:00", "5.200.000đ", "0đ"},
